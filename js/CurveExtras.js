 ...
 * @author zz85
 *
 * Slightly modified version by cosmicmac (see !cosmicmac comments)
 *
...
THREE.Curves.GrannyKnot = THREE.Curve.create(
    ...
    function (t) {
        ...
        return new THREE.Vector3(x, y, z)
            .applyAxisAngle(new THREE.Vector3(1, 0, 0), Math.PI)   // !cosmicmac Rotate
...
THREE.Curves.VivianiCurve = THREE.Curve.create(
    function (s, r) {
        this.scale  = ( typeof s == "undefined" ? 1 : s);
        this.radius = ( typeof r == "undefined" ? 4 : s);
    },
    ...
    function (t) {
        ...
        return new THREE.Vector3(tx, ty, tz)
            .add(new THREE.Vector3(-this.radius / 3, 0, 0))             // !cosmicmac Translate
            .applyAxisAngle(new THREE.Vector3(0, 0, 1), -Math.PI / 2)   // !cosmicmac Rotate
            .multiplyScalar(this.scale);
...
THREE.Curves.KnotCurve = THREE.Curve.create(
    ...
    function (t) {
        ...
        return new THREE.Vector3(tx, ty, tz)
            .add(new THREE.Vector3(0, -30, 0))                      // !cosmicmac Translate
            .applyAxisAngle(new THREE.Vector3(1, 0, 0), Math.PI)    // !cosmicmac Rotate
            .multiplyScalar(this.scale);
...
THREE.Curves.TrefoilKnot = THREE.Curve.create(
    ...
    function (t) {
        ...
        return new THREE.Vector3(tx, ty, tz)
            .applyAxisAngle(new THREE.Vector3(1, 0, 0), Math.PI/2)   // !cosmicmac Rotate
            .multiplyScalar(this.scale);
